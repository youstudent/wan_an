...
$this->title='Parsing / Upload'  backend\models\Member 'excel';
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Member', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Member</h1>
    </div>


    <div class="backend\models\Member-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('member/sample');?>">member.xls</a>
        </div>
