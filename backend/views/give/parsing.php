...
//$this->title='Parsing / Upload'  common\models\Give 'excel';
$this->params['breadcrumbs'][] = ['label' => ' common\models\Give', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel common\models\Give</h1>
    </div>


    <div class="common\models\Give-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('give/sample');?>">give.xls</a>
        </div>
