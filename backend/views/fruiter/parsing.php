...
$this->title='Parsing / Upload'  backend\models\Fruiter 'excel';
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Fruiter', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Fruiter</h1>
    </div>


    <div class="backend\models\Fruiter-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('fruiter/sample');?>">fruiter.xls</a>
        </div>
