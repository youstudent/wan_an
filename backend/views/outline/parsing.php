...
$this->title='Parsing / Upload'  backend\models\Outline 'excel';
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Outline', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Outline</h1>
    </div>


    <div class="backend\models\Outline-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('outline/sample');?>">outline.xls</a>
        </div>
