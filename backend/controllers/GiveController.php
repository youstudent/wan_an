...
use backend\models\searchs\GiveSearchs;
...
/**
 * GiveController implements the CRUD actions for Give model.
 */
class GiveController extends Controller
{
    ...
    /**
     * Lists all Give models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new GiveSearchs();
    ...
    /**
     * Updates an existing Give model.
    ...
    /**
     * Deletes an existing Give model.
    ...
    /**
     * Finds the Give model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return Give the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Give::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionParsing() {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if ($model->save()) {
                ...
                $notification->title = 'parsing Give';
                $notification->message = Yii::$app->user->identity->username . ' parsing Give ';
                $notification->params = \yii\helpers\Json::encode(['model' => 'Give', 'id' => $model->id]);
                $notification->save();
            }
        }
        $route = 'give/parsing-log';
