...
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Announcements', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Announcements</h1>
    </div>


    <div class="backend\models\Announcements-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('announcements/sample');?>">announcements.xls</a>
        </div>
