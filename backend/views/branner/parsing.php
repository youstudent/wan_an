...
$this->title='Parsing / Upload'  backend\models\Branner 'excel';
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Branner', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Branner</h1>
    </div>


    <div class="backend\models\Branner-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('branner/sample');?>">branner.xls</a>
        </div>
