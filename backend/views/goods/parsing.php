...
$this->title='Parsing / Upload'  backend\models\Goods 'excel';
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Goods', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Goods</h1>
    </div>


    <div class="backend\models\Goods-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('goods/sample');?>">goods.xls</a>
        </div>
