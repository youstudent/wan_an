...
$this->title='Parsing / Upload'  backend\models\Order 'excel';
$this->params['breadcrumbs'][] = ['label' => ' backend\models\Order', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel backend\models\Order</h1>
    </div>


    <div class="backend\models\Order-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('order/sample');?>">order.xls</a>
        </div>
